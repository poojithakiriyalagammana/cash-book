...
class CashOutScreen extends StatefulWidget {
  ...
  const CashOutScreen({super.key, this.transaction, this.recurringTransaction});
...
class _CashOutScreenState extends State<CashOutScreen> {
  ...
  String _selectedTransactionType = "Other Expense";
  ...
  void _resetForm() {
    setState(() {
      ...
      _paymentMode = 'Cash';
      _selectedTransactionType = "Other Expense";
      _isRecurring = false;
                  ...
                  children: [
                    ...
                    FutureBuilder<List<TransactionType>>(
                      future: DatabaseHelper.instance
                          .getTransactionTypesByCategory('out'),
                      builder: (context, snapshot) {
                        ...
                        bool otherExpenseExists =
                            items.any((item) => item.name == "Other Expense");
                        final List<DropdownMenuItem<String>> dropdownItems = [
                          // Always add "Other Expense" as the first item
                          DropdownMenuItem(
                            value: "Other Expense",
                            child: Row(
                        ...
                        dropdownItems.addAll(items
                            .where((type) => type.name != "Other Expense")
